`ifndef I3C_SDR_WRITE_VIRTUAL_SEQ_LEN_16_WDATA_5555_INCLUDED_
`define I3C_SDR_WRITE_VIRTUAL_SEQ_LEN_16_WDATA_5555_INCLUDED_
class i3c_sdr_write_virtual_seq_len_16_wdata_5555 extends top_virtual_base_seq;
  `uvm_object_utils(i3c_sdr_write_virtual_seq_len_16_wdata_5555)
  uvm_status_e   status;
  ...
  function new(string name = "i3c_sdr_write_virtual_seq_len_16_wdata_5555");
    super.new(name);
  endfunction
  task body();
    ...
    `uvm_info(get_type_name(),
      ...
      UVM_LOW)
  endtask : body
endclass : i3c_sdr_write_virtual_seq_len_16_wdata_5555
`endif
