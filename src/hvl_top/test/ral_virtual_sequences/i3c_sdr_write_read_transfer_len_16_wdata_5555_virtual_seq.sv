`ifndef I3C_SDR_WRITE_READ_TRANSFER_LEN_16_WDATA_5555_VIRTUAL_SEQ_INCLUDED_
`define I3C_SDR_WRITE_READ_TRANSFER_LEN_16_WDATA_5555_VIRTUAL_SEQ_INCLUDED_
class i3c_sdr_write_read_transfer_len_16_wdata_5555_virtual_seq extends top_virtual_base_seq;
  `uvm_object_utils(i3c_sdr_write_read_transfer_len_16_wdata_5555_virtual_seq)
  uvm_status_e   status;
  ...
  function new(string name = "i3c_sdr_write_read_transfer_len_16_wdata_5555_virtual_seq ");
    super.new(name);
  endfunction
  task body();
    ...
    `uvm_info(get_type_name(),
      ...
      UVM_LOW)
  endtask : body
endclass : i3c_sdr_write_read_transfer_len_16_wdata_5555_virtual_seq
`endif
