`ifndef I3C_SDR_WRITE_READ_TRANSFER_LEN_4_VIRTUAL_SEQ_INCLUDED_
`define I3C_SDR_WRITE_READ_TRANSFER_LEN_4_VIRTUAL_SEQ_INCLUDED_
class i3c_sdr_write_read_transfer_len_4_virtual_seq extends top_virtual_base_seq;
  `uvm_object_utils(i3c_sdr_write_read_transfer_len_4_virtual_seq)
  uvm_status_e   status;
  uvm_reg_data_t ctrl_val;
  uvm_reg_data_t ctrl_mirror;
  int unsigned target_idx = 0;
  rand bit [7:0] wdata_bytes [0:3];
  ...
  function new(string name = "i3c_sdr_write_read_transfer_len_4_virtual_seq");
    super.new(name);
  endfunction
  task body();
    ...
    `uvm_info(get_type_name(),
      ...
      UVM_LOW)
  endtask : body
endclass : i3c_sdr_write_read_transfer_len_4_virtual_seq
`endif
