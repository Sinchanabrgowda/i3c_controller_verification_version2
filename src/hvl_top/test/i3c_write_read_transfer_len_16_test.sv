class i3c_write_read_transfer_len_16_test extends i3c_base_test;
  `uvm_component_utils(i3c_write_read_transfer_len_16_test)
  i3c_daa_virtual_seq daaSeq;
  i3c_sdr_write_read_transfer_len_16_virtual_seq sdrWriteReadmultitransferlenSeq;
  function new(string name = "i3c_write_read_transfer_len_16_test",
  ...
  virtual task run_phase(uvm_phase phase);
    ...
    sdrWriteReadmultitransferlenSeq =
      i3c_sdr_write_read_transfer_len_16_virtual_seq::type_id::create(
        "sdrWriteReadmultitransferlenSeq");
