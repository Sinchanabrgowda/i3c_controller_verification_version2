class i3c_daa_write_8b_test_wdata_AA extends i3c_base_test;
  `uvm_component_utils(i3c_daa_write_8b_test_wdata_AA)
  i3c_daa_virtual_seq       daaSeq;
  i3c_sdr_write_virtual_seq_wdata_AA sdrWriteSeq;
  function new(string name = "i3c_daa_write_8b_test_wdata_AA",
  ...
  virtual task run_phase(uvm_phase phase);
    ...
    sdrWriteSeq = i3c_sdr_write_virtual_seq_wdata_AA::type_id::create("sdrWriteSeq");
