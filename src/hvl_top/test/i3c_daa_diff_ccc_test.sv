class i3c_daa_diff_ccc_test extends i3c_base_test;
  `uvm_component_utils(i3c_daa_diff_ccc_test)
  i3c_daa_diff_ccc_virtual_seq     daaSeq;
  function new(string name = "i3c_daa_diff_ccc_test",
  ...
  virtual task run_phase(uvm_phase phase);
    ...
    `uvm_info(get_type_name(),
              $sformatf("Starting multi-slave DAA test with diff ccc(%0d targets)", NO_OF_TARGETS),
      UVM_LOW)
    daaSeq = i3c_daa_diff_ccc_virtual_seq::type_id::create("daaSeq");
