class i3c_daa_write_8b_test_wdata_FF extends i3c_base_test;
  `uvm_component_utils(i3c_daa_write_8b_test_wdata_FF)
  i3c_daa_virtual_seq       daaSeq;
  i3c_sdr_write_virtual_seq_wdata_FF sdrWriteSeq;
  function new(string name = "i3c_daa_write_8b_test_wdata_FF",
  ...
  virtual task run_phase(uvm_phase phase);
    ...
    sdrWriteSeq = i3c_sdr_write_virtual_seq_wdata_FF::type_id::create("sdrWriteSeq");
