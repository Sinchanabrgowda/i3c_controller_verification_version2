class i3c_daa_write_nack_8b_test extends i3c_base_test;
  `uvm_component_utils(i3c_daa_write_nack_8b_test)
  i3c_daa_virtual_seq       daaSeq;
  i3c_sdr_write_nack_virtual_seq sdrWriteSeq;
  function new(string name = "i3c_daa_write_nack_8b_test",
  ...
  virtual task run_phase(uvm_phase phase);
    ...
    sdrWriteSeq = i3c_sdr_write_nack_virtual_seq::type_id::create("sdrWriteSeq");
