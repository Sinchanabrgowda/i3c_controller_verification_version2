class i3c_daa_write_8b_test_len_1_wdata_55 extends i3c_base_test;
  `uvm_component_utils(i3c_daa_write_8b_test_len_1_wdata_55)
  i3c_daa_virtual_seq daaSeq;
  i3c_sdr_write_virtual_seq_len_1_wdata_55 sdrWriteSeq;
  function new(string name = "i3c_daa_write_8b_test_len_1_wdata_55",
  ...
  virtual task run_phase(uvm_phase phase);
    ...
    sdrWriteSeq =
      i3c_sdr_write_virtual_seq_len_1_wdata_55::type_id::create("sdrWriteSeq");
