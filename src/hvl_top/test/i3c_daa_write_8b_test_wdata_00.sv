class i3c_daa_write_8b_test_wdata_00 extends i3c_base_test;
  `uvm_component_utils(i3c_daa_write_8b_test_wdata_00)
  i3c_daa_virtual_seq daaSeq;
  i3c_sdr_write_virtual_seq_wdata_00 sdrWriteSeq;
  function new(string name = "i3c_daa_write_8b_test_wdata_00",
  ...
  virtual task run_phase(uvm_phase phase);
    ...
    sdrWriteSeq =
      i3c_sdr_write_virtual_seq_wdata_00::type_id::create("sdrWriteSeq");
